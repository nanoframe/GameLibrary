package com.paperatus.core.components
...
import com.paperatus.core.physics.PhysicsBodyData
import com.paperatus.core.physics.RectangleShape
...
open class PhysicsComponent(private val data: PhysicsBodyData) : Component {
    ...
    fun init(world: World) {
        ...
        when (dataShape) {
            is com.paperatus.core.physics.CircleShape -> {
